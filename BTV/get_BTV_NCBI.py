...
btv_segment1_meta = open("btv_segment1.meta", "w")
btv_segment2_fasta = open("btv_segment2.fasta", "w")
btv_segment2_meta = open("btv_segment2.meta", "w")
btv_segment3_fasta = open("btv_segment3.fasta", "w")
btv_segment3_meta = open("btv_segment3.meta", "w")
btv_segment4_fasta = open("btv_segment4.fasta", "w")
btv_segment4_meta = open("btv_segment4.meta", "w")
btv_segment5_fasta = open("btv_segment5.fasta", "w")
btv_segment5_meta = open("btv_segment5.meta", "w")
btv_segment6_fasta = open("btv_segment6.fasta", "w")
btv_segment6_meta = open("btv_segment6.meta", "w")
btv_segment7_fasta = open("btv_segment7.fasta", "w")
btv_segment7_meta = open("btv_segment7.meta", "w")
btv_segment8_fasta = open("btv_segment8.fasta", "w")
btv_segment8_meta = open("btv_segment8.meta", "w")
btv_segment9_fasta = open("btv_segment9.fasta", "w")
btv_segment9_meta = open("btv_segment9.meta", "w")
btv_segment10_fasta = open("btv_segment10.fasta", "w")
btv_segment10_meta = open("btv_segment10.meta", "w")
...
with open("AUS_BTV_ISOLATES.txt") as f:
    ...
    for lines in f:
        ...
        for index, segment_id in enumerate(cols[5:]):
            ...
            fasta_file_list[index].write(">" + strain + "_" + "segment" + str(segment) + "\n" + str(record[1].seq) +
                                        "\n")
            meta_file_list[index].write("\t".join([strain, virus, segment_id, str(segment), type, state, date,
                                                   record[0][1], record[0][2], record[0][3], record[0][4],
