...
print("Total number of clusters: {}".format(len(cluster_to_strain)))
print("Total number of strains: {}".format(len(strain_to_cluster)) + "\n")
    ...
    for record in SeqIO.parse(fl, "fasta"):
        ...
        if len(cluster_to_strain[record_cluster]) == 1:
            ...
            if record_cluster in processed_clusters:
                ...
                location = meta_dict[record_id]["location"]
                country = meta_dict[record_id]["country"]
                date = meta_dict[record_id]["date"]
                host = meta_dict[record_id]["host"]
                ...
                for strain in cluster_to_strain[record_cluster]:
                    ...
                    if meta_dict[strain]["location"] == location and \
                       meta_dict[strain]["country"] == country and \
                       meta_dict[strain]["date"] == date and \
                       meta_dict[strain]["host"] != host:
                       ...
                       # will add the id to a list instead, then check against this as records come through
                        ...
                        meta_to_write[strain] = meta_dict[strain]["line"]

print(len(strains_to_write))
